...
def selects_the_titles_of_all_projects_and_their_pledge_amounts_alphetized_by_title
...
def selects_the_user_name_age_and_pledge_amount_for_all_pledges_alphebatized_by_name
...
def selects_user_names_and_amounts_of_all_pledges_grouped_by_name_then_orders_them_by_summed_amount
